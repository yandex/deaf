...
public class NoConnectionDialogFragment extends AbstractAlertDialogFragment {
    ...
    public View onCreateDialogView(final LayoutInflater inflater, final ViewGroup container,
        ...
        return inflater.inflate(R.layout.dialog_fragment_no_connection, container, false);
    }
